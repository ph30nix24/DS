...
import { HeroIllustration, HeroImage } from '../../utils';

const HomeHero = () => {
  const heroImg =  useRef(null);
  const heroDescrib =  useRef(null);
  useGSAP(() => {
  ...
  return (
    <div className='w-full h-screen sm:h-screen md:h-[60dvh] lg:h-[100dvh] pt-[80px] bg-hero relative -z-10 lg:flex lg:flex-col items-center'>
      <div className='flex w-full h-full lg:h-[90%] flex-col md:flex-row md:items-center'>
        <img src={HeroImage} className='w-full h-1/2 object-contain md:w-1/2 md:h-full lg:w-2/5 lg:mx-[5%] lg:pt-16' ref={heroImg} alt="heroImg" />
        <div className='w-full h-1/2 md:w-1/2 md:h-full flex flex-col justify-start pt-5 sm:pt-0 items-center md:justify-center' ref={heroDescrib}>
      ...
      <div className='w-full hidden lg:block lg:h-1/5 text-center text-[1.8vw] font-para' id='descriptions'>
